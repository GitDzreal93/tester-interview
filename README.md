...
工作这几年中，作为求职者，面试过好多公司；作为面试官，也面试过不少人。

记得当初在备战「阿里巴巴-测试开发岗位」面试的前夜，我在网络上到处搜罗面经和面试题，但是我发现测试岗位相关的面试题，真的是太散了，看完之后，不能形成知识体系，就像存储在内存里的数据，断电之后就没了。

**面试不仅仅是公司选拔人才的途径，更是一面镜子，让求职者知道自己哪里不足，然后方能加以改进。**

所以，我萌生了创建一个测试相关岗位面试题的项目，目的不是为了面试之前方便突击复习，而是把面试题都作为知识点，检验自己是否有所掌握。
...
<p align="center" display="none">
  <a  href="" alt="banner位置">
<img src=""width="" style="margin: 0 auto;"/>
  </a >
</p>
